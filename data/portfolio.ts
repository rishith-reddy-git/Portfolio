...
export const heroHighlights = [
  {
    ...
    copy: "Mentored 50+ engineers across full-stack architecture, code reviews, system design, and production workflows.",
    tag: "FDT MENTOR",
    color: "#38bdf8",
  ...
  },
  {
    ...
    copy: "Directed 5+ student software projects from initial system architecture to live cloud deployment.",
    tag: "FULL STACK",
    color: "#ef4444",
  ...
  },
  {
    ...
    copy: "Selected for the prestigious NASSCOM thingQubator innovation program — driving AI prototypes and startup execution.",
    tag: "NASSCOM",
    color: "#ef4444",
    accentGlow: "rgba(239, 68, 68, 0.28)",
