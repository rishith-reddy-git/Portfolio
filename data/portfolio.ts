...
export const heroHighlights = [
  {
    ...
    copy: "Mentored 50+ students across full-stack architecture, code reviews, system design, and production workflows.",
    tag: "FDT MENTOR",
    color: "#38bdf8",
  ...
  },
  {
    ...
    category: "Projects",
    stat: "5+ Projects",
    title: "Full-Stack Software Guidance",
    copy: "Directed 5+ student software projects from initial concept to live cloud production deployment.",
    tag: "FULL STACK",
    color: "#ef4444",
  ...
  {
    badge: "INCUBATION SELECTION",
    category: "Incubation",
    stat: "2026 Cohort",
    title: "NASSCOM thingQubator Program",
    copy: "Selected for the prestigious NASSCOM thingQubator innovation program — driving AI prototypes and product execution.",
    tag: "NASSCOM",
    color: "#ef4444",
    accentGlow: "rgba(239, 68, 68, 0.22)",
  ...
  },
  {
    ...
    copy: "Real-time telemetry and predictive ML dashboard deployed on live production infrastructure.",
    tag: "AI / ML",
    color: "#38bdf8",
    accentGlow: "rgba(56, 189, 248, 0.22)",
